      ...
      >
          <SwiperSlide>
              <div className="custom-card flex flex-col items-start justify-center">
                  <h2 className="xl:text-8xl text-6xl capitalize font-teko font-extrabold mb-2 text-white">sukseskan</h2>
                  <h2 className="xl:text-8xl text-6xl capitalize font-teko font-extrabold mb-2 text-white">event mu</h2>
          ...
          <SwiperSlide>
              <div className="custom-card flex flex-col items-start justify-center bg-transparent">
                  <h2 className="xl:text-8xl text-6xl capitalize font-teko font-extrabold mb-2 text-blue-400">videotron</h2>
                  <h2 className="xl:text-8xl text-6xl capitalize font-teko font-extrabold mb-2 text-white text-start">mulai <span className='text-red-500'>P4</span> hingga <span className='text-red-500'>P1.5</span></h2>
          ...
          <SwiperSlide>
              <div className="custom-card flex flex-col items-start justify-center bg-transparent">
                  <h2 className="xl:text-8xl text-6xl capitalize font-teko font-extrabold mb-2 text-blue-400">Paket</h2>
                  <h2 className="xl:text-8xl text-6xl capitalize font-teko font-extrabold mb-2 text-white">Sound System</h2>
          ...
          <SwiperSlide>
              <div className="custom-card flex flex-col items-start justify-center bg-transparent">
                  <h2 className="xl:text-8xl text-6xl capitalize font-teko font-extrabold mb-2 text-blue-400">TV Led</h2>
          ...
          <SwiperSlide>
              <div className="custom-card flex flex-col items-start justify-center bg-transparent">
                  <h2 className="xl:text-8xl text-6xl text-start capitalize font-teko font-extrabold mb-2 text-blue-400">video mapping</h2>
                  <h2 className="xl:text-8xl text-6xl capitalize font-teko font-extrabold mb-2 text-start text-white">ukuran 120 - 300</h2>
          ...
          <SwiperSlide>
              <div className="custom-card flex flex-col items-start justify-center bg-transparent">
                  <h2 className="xl:text-8xl text-6xl capitalize font-teko font-extrabold mb-2 text-blue-400 text-start">digital promotion</h2>
                  <h2 className="xl:text-8xl text-6xl capitalize font-teko font-extrabold mb-2 text-white">on <span className='text-red-500'>event</span></h2>
