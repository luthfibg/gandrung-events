    ...
    <nav className="text-gray-800 fixed m-4 md:m-8 bg-white rounded-2xl z-20 top-0 start-0 border-b border-default">
      <div className="max-w-7xl flex flex-wrap items-center justify-between mx-auto">
        ...
        <div className="hidden md:flex lg:flex-1 flex-2 justify-start py-3 px-5" id="navbar-left-desktop">
          <ul className="flex lg:text-2xl flex-col font-mulish justify-center p-4 md:p-0 font-medium border border-default rounded-base md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
            <li>
        ...
        <div className="py-3 px-3 flex justify-center lg:flex-4 flex-2 w-full md:w-auto font-teko">
          <a href="#" className="flex items-center justify-center space-x-3 rtl:space-x-reverse">
            <span className="self-center text-gray-900 lg:text-3xl font-semibold whitespace-nowrap">Gandrung Event</span>
          </a>
        </div>
